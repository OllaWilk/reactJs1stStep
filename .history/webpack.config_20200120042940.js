...
const baseConfig = () => ({
  ...
  output: {         // output wskazjuje miejsce w którym ma być wygenerowana wersja produkcyjna, stworzona za pomocją komenty npm run build. Odpowiada też za nzawę pliku w którym znajduje się scalony i skonwertowany kod js aplikacji.
    ...
    publicPath: '/', //to jest potrzebne ponieważ aplikacja działa pod adresami które domyślnie będą podkatalogami projektu
  },
  devServer: {
    historyApiFallback: true, //to umożliwia serwerowi pliku index html oraz aplikacji w których serwer zwraca eroro 404
  },
  ...
  plugins: [        //lista wtyczek webpacka które śą niezbędne w naszej aplikacji.
